...
public partial class EmployeeList : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sql = "select EmployeeID, FirstName, LastName, BusinessEmail from dbo.employee";
        ...
        try
        {
            ...
            while (dataReader.Read())
            {
                ...
                Response.Write(linkTxt + " - <span>" + dataReader.GetValue(1) + "</span> - <span>" + dataReader.GetValue(2) + "</span> - <span>" + dataReader.GetValue(3) + "</span></br>");
            }
            dataReader.Close();
            command.Dispose();
            connection.Close();
