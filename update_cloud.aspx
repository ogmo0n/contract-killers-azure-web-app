<%@ Page Language="C#" AutoEventWireup="true" CodeFile="update_cloud.aspx.cs" Inherits="update_cloud" %>
...
<body>
    ...
    <div>
		<h2 class="titles">Update Employee Information</h2>
	</div>
	<div>
    ...
    <form id="form1" runat="server">
		...
		<div>
			<asp:Button ID="Button1" runat="server" Text="Update" class="button" onClick="do_update"/>
		</div>
	</form>
    <div>
		<div class="icons">
